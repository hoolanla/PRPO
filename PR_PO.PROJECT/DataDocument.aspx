<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="DataDocument.aspx.cs" Inherits="PR_PO.PROJECT.DataDocument" %>
...
.hiddencol { display: none; }
    ...
    <Columns>
     ...
     <asp:ImageButton ID="ImagePDF" runat="server" CausesValidation="false" CommandName="" ImageUrl="~/Images/pdf.png" Height="20" Width="20" Text='<%# Eval("doc_id") %>' />
            ...
            <telerik:GridTemplateColumn HeaderText="Open PO">
        <ItemTemplate>
     
                      <asp:LinkButton ID="OPEN_PO" runat="server" CommandArgument='<%# Eval("doc_id") %>' CommandName="OPEN_PO">Click</asp:LinkButton>
     </ItemTemplate>
       </telerik:GridTemplateColumn>
