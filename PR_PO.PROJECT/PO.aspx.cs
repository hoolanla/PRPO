...
namespace PR_PO.PROJECT
{
    public partial class PO : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string sql = "select doc_id,doc_name,content,create_by,create_date,secure_prepare,step1,step2,step3,step4,secure_approve,approve_problem From document where step4 = 1 order by doc_id desc";
            DataTable dt;
