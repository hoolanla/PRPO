...
{
    public partial class PO_FrmApplicationReview : System.Web.UI.Page
    {
        String DL = null;
        String DT = null;
        ...
        void testPostback()
        {
            ...
            var url = Request.Url.GetLeftPart(UriPartial.Authority) + Request.ApplicationPath + "/PO_FrmApplicationReview.aspx?doc_id=" + doc_id.Value + "&signature=" + signature_file.Value + "&page_count=" + page_count.Value + "&paper_type=" + paper_type.Value;
            ...
            if (HtmlToPdf(currentFile, doc_id.Value,paper_type.Value))
            {
                ...
                L.content = "Sign PO review success.";
...
//Response.Redirect("./PdfPrepare/" + doc_id.Value + ".Pdf");
        ...
        public static bool HtmlToPdf(string Url, string outputFilename,string paper_type)
        {
            ...
            string filename = HttpContext.Current.Server.MapPath("./PO_PdfReview/" + outputFilename + ".pdf");
