<%@ Page Title="Sendmail Approve" Language="C#" MasterPageFile="~/Masterpage/Site.Master" AutoEventWireup="true" CodeBehind="PO_SendMailApprove.aspx.cs" Inherits="PR_PO.PROJECT.PO_SendMailApprove"  EnableEventValidation="FALSE" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CotentScript" runat="server">
    ...
    <script src="<%=ResolveClientUrl("~/Scripts/pageScript/PO_SendMailApprove.js")%>"></script>
