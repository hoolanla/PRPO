<%@ Page Title="Sendmail request" Language="C#" MasterPageFile="~/Masterpage/Site.Master" AutoEventWireup="true" CodeBehind="PO_SendMailRequest.aspx.cs" Inherits="PR_PO.PROJECT.PO_SendMailRequest"  EnableEventValidation="FALSE" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel-body"><h2>PO: Sendmail Request</h2></div>
  </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CotentScript" runat="server">
    ...
    <script src="<%=ResolveClientUrl("~/Scripts/pageScript/PO_SendMailRequest.js")%>"></script>
