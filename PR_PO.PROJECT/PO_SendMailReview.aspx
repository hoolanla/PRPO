<%@ Page Title="Sendmail Review" Language="C#" MasterPageFile="~/Masterpage/Site.Master" AutoEventWireup="true" CodeBehind="PO_SendMailReview.aspx.cs" Inherits="PR_PO.PROJECT.PO_SendMailReview"  EnableEventValidation="FALSE" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel-body"><h2>PO: Sendmail Review</h2></div>
  </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CotentScript" runat="server">
    ...
    <script src="<%=ResolveClientUrl("~/Scripts/pageScript/PO_SendMailReview.js")%>"></script>
