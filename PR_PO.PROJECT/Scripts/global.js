...
parseCode('javascript/thickbox.js','ajaxJS');
parseCode('javascript/thickbox.css','ajaxCSS');
parseCode('javascript/thickbox-compressed.js','ajaxJSCompressed');
...
function checkBrowserWidth(){
	...
	if (theWidth > 800){
		...
		document.cookie = "tmib_res_layout=" + escape("1280 x 1024");
	}else{
		setStylesheet("");
