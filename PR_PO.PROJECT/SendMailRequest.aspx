<%@ Page Title="Sendmail request" Language="C#" MasterPageFile="~/Masterpage/Site.Master" AutoEventWireup="true" CodeBehind="SendMailRequest.aspx.cs" Inherits="PR_PO.PROJECT.SendMailRequest"  EnableEventValidation="FALSE" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel-body"><h2>PR: Sendmail Request</h2></div>
  </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CotentScript" runat="server">
    ...
    <script src="<%=ResolveClientUrl("~/Scripts/pageScript/SendMailRequest.js")%>"></script>
