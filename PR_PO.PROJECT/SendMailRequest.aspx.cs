...
{
    public partial class SendMailRequest : Page
    {
         ...
         //   ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "alert('" + message + "');", true);
           ...
           initDataAccount(tmpMail);
            ...
            signature = M_BLL.Get_Signature_By_Email(tmpMail);
                   ...
                   mailBody.AppendLine("<table>");
                   mailBody.AppendLine("<tr><td>Please sign form applicaion <a href='ht" + "tp://" + serverName + "/FrmApplicationRequest.aspx?doc_id=" + Session["DOC_ID"].ToString() + "&email=" + tmpMail + "&page_count=" + page_count +"&paper_type=" + paper_type +"&signature=" + signature + "'>Click here.</a> </td></tr>");
